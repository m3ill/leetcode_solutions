...
Welcome to my personal LeetCode repository! Here, I systematically document my problem-solving journey, focus on algorithmic thinking, and practice optimal solutions primarily in **C** and **C++**.

---

## 📊 Profile & Progress Summary

> 👤 **LeetCode Profile:** [Mertcan (@Mertcanii)](https://leetcode.com/u/Mertcanii/)
...
- [ ] Ensure optimal time complexity ($O(n)$ or $O(n \log n)$) in all solutions
- [ ] Deepen knowledge of C++ STL and memory management
